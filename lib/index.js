...
const bearer = module.exports = Object.create({Stored: keep})
 ...
 * @param {object} models
 */
bearer.Register = (components, actions = {}, models = {}) => {
  const nodes = {}
  /**
   * Models
   */
  ...
  for(let name in components) {
     ...
     * Bind actions to component
     */
    nodes[name] = bearer.Bind(memo, actions)
  }
  /**
   * Keep persistent
   */
